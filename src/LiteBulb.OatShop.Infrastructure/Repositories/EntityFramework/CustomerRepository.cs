...
public class CustomerRepository : ICustomerRepository
{
    ...
    private DbSet<Entities.Customer> _dbSet => _dbContext.Set<Entities.Customer>();

    public CustomerRepository(ILogger<CustomerRepository> logger, OatShopDbContext dbContext)
    {
